...
class RecyclerView_Item_Adapter(var mList:List<RecyclerView_Item_Data>) : RecyclerView.Adapter<RecyclerView_Item_Adapter.RecyclerView_Item_Holder>() {

    var onItemClick : ((RecyclerView_Item_Data) -> Unit)?=null
    ...
    fun setFilteredList(mList: List<RecyclerView_Item_Data>){
        this.mList=mList
