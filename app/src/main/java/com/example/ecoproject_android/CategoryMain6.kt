...
class CategoryMain6 : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        cosmetics.setOnClickListener{
            val intent= Intent(this, Category6Cosmetics::class.java)
            startActivity(intent)
        }
        perfume.setOnClickListener{
            val intent= Intent(this, Category6Perfume::class.java)
            startActivity(intent)
        }
        cosmeticsstick.setOnClickListener{
            val intent= Intent(this, Category6Cosmeticsstick::class.java)
            startActivity(intent)
        }
        cosmeticstube.setOnClickListener{
            val intent= Intent(this, Category6Cosmeticstube::class.java)
            startActivity(intent)
        }
        cosmeticspumptype.setOnClickListener{
            val intent= Intent(this, Category6Cosmeticspumptype::class.java)
            startActivity(intent)
        }
